 public class Exit { // Numerical codes 
     ...
     public Exit() 
     {
        ...
        public Exit( int direction, Location leadsTo )
        {
            ...
            if (direction <= dirName.length ) m_directionName = dirName[m_direction];
            if (direction <= shortDirName.length ) m_shortDirectionName = shortDirName[m_direction];
            // Assign location
            m_leadsTo = leadsTo;
        }
        // toString method 
